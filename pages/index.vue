<template>
    <header class="h-screen w-full main-body relative">
        <div class="absolute top-0 left-0 h-full w-full overlay"></div>
        <div class="max-w-4xl m-auto px-4 z-20 relative flex items-center h-full">
            <div>
                <h1 class="title 645px:text-[8rem] 645px:leading-[8rem] 410px:text-[6rem] 410px:leading-[6rem]">Explore.<br>Build.<br>Survive.</h1>
                <p class="text-light-gray mb-3 font-semibold text-[18px] leading-8 410px:text-[14px] 410px:leading-5">The only aim in RustySquare is to survive. Environment wants you dead <br> by any mean - the island’s wildlife like Boars, Bears, the environment itself. <br> Do whatever it takes to last another night. <br>Good Night, Good Luck</p>
                <ul class="flex items-center link flex-wrap w-fit">
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 m-2" to="steam://connect/109.205.61.128:38015">2X US</NuxtLink>
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 m-2" to="steam://connect/109.205.61.128:48015">5X US</NuxtLink>
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 m-2" to="steam://connect/109.205.61.128:39015">10X US</NuxtLink>

                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 m-2" to="steam://connect/188.244.117.31:28015">2X EU</NuxtLink>
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 m-2" to="steam://connect/188.244.117.31:29015">3X EU</NuxtLink>
                </ul>
            </div>
        </div>
    </header>
