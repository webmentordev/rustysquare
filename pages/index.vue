    ...
    <header class="h-screen w-full main-body relative">
        ...
        <div class="max-w-4xl m-auto px-4 z-20 relative flex items-center h-full">
            <div>
                ...
                <p class="text-light-gray mb-3 font-semibold text-[18px] leading-8 410px:text-[14px] 410px:leading-5">The only aim in RustySquare is to survive. Environment wants you dead <br> by any mean - the island’s wildlife like Boars, Bears, the environment itself <br> & the undead. Do whatever it takes to last another night. <br>Good Night, Good Luck</p>
                <ul class="flex items-center link">
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 mr-3" to="steam://connect/193.29.62.87:38015">2X US</NuxtLink>
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6" to="steam://connect/193.29.62.87:39015">10X US</NuxtLink>
                </ul>
            </div>
        </div>
    </header>
