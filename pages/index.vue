    ...
    <header class="h-screen w-full main-body relative">
        ...
        <div class="max-w-4xl m-auto px-4 z-20 relative flex items-center h-full">
            <div>
                ...
                <ul class="flex items-center link">
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 mr-3" to="steam://connect/109.205.61.128:38015">2X US</NuxtLink>
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6 mr-3" to="steam://connect/109.205.61.128:48015">5X US</NuxtLink>
                    <NuxtLink class="bg-main text-white text-xl py-2 px-6" to="steam://connect/109.205.61.128:39015">10X US</NuxtLink>
                </ul>
            </div>
        </div>
    </header>
